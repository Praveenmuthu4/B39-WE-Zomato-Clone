...
export default function Register() {
  ...
  const navigate = useNavigate();
    ...
    const addUserdata = async (e) => {
        ...
        } else if(!phone.includes(parsePhoneNumber)){
            toast.error("include only number",{
                position:"top-center"
            }) 
        }else if (password === "") {
            ...
            <section>
                <div className="form_data">
                    <form>
                        ...
                        <div className="form_input">
                            <label >Phone</label>
                            <input type="email" onChange={setVal} value={inpval.phone} name="phone" id="phone" placeholder='Enter Your Phone Number' />
                        </div>
                        <div className="form_input">
                        ...
                        <p>Already have an account? <a href="#" underline="hover" onClick={()=>navigate('/')}>Log In</a></p>
                    </form>
                    <ToastContainer />
                </div>
            </section>
