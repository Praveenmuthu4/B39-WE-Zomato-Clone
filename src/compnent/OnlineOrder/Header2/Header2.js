...
export default function Header2() {
  return (
    <div class="sc-hVlJqk isXUwf">
      <div class="sc-1mo3ldo-0 fihUGr">
        <div class="sc-lEDTX fqImET">
          <div class="sc-fElddq jfdJCi">
            <div tabindex="0" class="sc-emDGWR darVAi">
              <div class="sc-bQEgQf Kmfjp">
